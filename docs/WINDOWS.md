...
- Windows 10/11 **x64**，建议 16 GB 或更多内存，预留至少 10 GB 磁盘空间。
...
1. 从 [Releases](https://github.com/bushushu2333/macmic/releases) 下载 `macmic-0.1.0-windows-x64-setup.exe` 并安装。安装包未使用商业代码签名证书，Windows 可能提示未知发布者；只使用本仓库发布的文件并核对 SHA-256。
...
5. 打开麦麦，在“偏好设置”点“重启模型”，等待“本地模型已就绪”。允许 Windows 设置中的麦克风及“让桌面应用访问麦克风”。
...
目前 Windows 版是首个预览版本。自动化构建和公开音频模型测试的结果可在 Actions 查看；真实麦克风、不同键盘以及各应用的粘贴兼容性仍需 Windows 实机体验反馈。
